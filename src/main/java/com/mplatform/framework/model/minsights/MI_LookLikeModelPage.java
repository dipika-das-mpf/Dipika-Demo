 ...
 */
public class MI_LookLikeModelPage extends MI_Audience_Menu {

    public MI_LookLikeModelPage(WebDriver driver) {
        super(driver);
    }
    ...
    @FindBy(xpath = "/html/body/div[3]/div/div[1]/div[4]/div[3]/div/div[1]/div/div/input[2]") public WebElement selectLookLikeAdvertiserScope_DropDownIcon;


    @FindBy(xpath = "/html/body/div[3]/div/div[2]/div/div[3]/div[2]/div/div/div[2]/div[2]/div/div/div[2]/div/div/div" +
            "[1" +
            "]/div[1]/div/div[2]/div/a")
    public WebElement selectLookLikeAttributeScope_DropDownIcon;

    @FindBy(xpath = "/html/body/div[3]/div/div[2]/div/div[3]/div[2]/div/div/div[2]/div[2]/div/div/div[2]/div/div/div" +
            "[1]/div[1]/div[3]/div[2]/div[2]/div[1]/div/div/input[2]")
    public
    WebElement selectLookLikeActivityAttributeScope_DropDownIcon;
    @FindBy(xpath = "/html/body/div[3]/div/div[2]/div/div[3]/div[2]/div/div/div[2]/div[2]/div/div/div[2]/div/div/div" +
            "[1]/div[1]/div[4]/div/div[2]/div[1]")
    public WebElement attributeactivitydurationcondition;



    @FindBy(xpath = "/html/body/div[3]/div/div[2]/div/div[3]/div[2]/div/div/div[2]/div[2]/div/div/div[2]/div/div/div" +
            "[1]/div[1]/div[4]/div/input[2]")
    public WebElement selectLookLikeActivityDurationAttributeScope_DropDownIcon;

    @FindBy(xpath = "/html/body/div[3]/div/div[2]/div/div[3]/div[2]/div/div/div[2]/div[2]/div/div/div[2]/div/div/div" +
            "[1]/div[1]/div[3]/div[2]/div[2]/div[1]/div/div/div[2]/div[1]")
    ...
    @FindBy(xpath = "/html/body/div[3]/div/div[2]/div/div[5]/div[2]/div/div/div[2]/div[4]/div/div/div[2]/div/div/div" +
            "[1]/div[1]/div[5]")
    public  WebElement CustomVariableConditionMoreValue_Excludenew;


    //*[@id="custTextVal"]
    //values are 'THESE_ADV" and 'ALL_ADV'
    public String looklikeAdvertiserScope = "/html/body/div[3]/div/div[1]/div[4]/div[3]/div/div[1]/div/div/div[2]/div[101]";

    public String attributecondition = "/html/body/div[3]/div/div[2]/div/div[3]/div[2]/div/div/div[2]/div[2]/div/div" +
            "/div[2]/div/div/div[1]/div[1]/div[1]/div[2]/div/div/div/div/div[2]/div/div/div/a[1]";
