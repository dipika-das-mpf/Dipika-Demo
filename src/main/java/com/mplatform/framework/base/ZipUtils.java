...
public class ZipUtils {
	...
	public ZipUtils() {
		HTMLFunctions objHTMLFunctions = new HTMLFunctions(null);
		SOURCE_FOLDER = HTMLFunctions.strCurrentExecutionFolderPath;
		OUTPUT_ZIP_FILE = SOURCE_FOLDER + ".zip";
	...
	public void zipIt(String zipFile) {
		...
		try {
			try {
				source = SOURCE_FOLDER.substring(SOURCE_FOLDER.lastIndexOf("/") + 1,
